...
class _CartPageState extends State<CartPage> {
          ...
          cartItems.isEmpty
              ...
              : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  String item = cartItems.keys.elementAt(
                    index,
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text(
                            'Quantity: $quantity x ₹${price.toStringAsFixed(2)}',
                          ),
                          Text(
                            'Price: ₹${(quantity * price).toStringAsFixed(2)}',
                            style: const TextStyle(fontWeight: FontWeight.bold),
                          ), //quantity and price of food item
                        ],
                      ),
                      trailing: Row(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed:
                        cartItems.isEmpty ? null : () => _proceedToPayment(),
  ...
  void _proceedToPayment() {
    if (cartItems.isNotEmpty) {
      List<Map<String, String>> paymentItems =
