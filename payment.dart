...
class _PaymentPageState extends State<PaymentPage> {
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                        ...
                        title: Row(
                          children: [
                            Image.asset(
                              ...
                              height: 30,
                              errorBuilder:
                                  (_, __, ___) => const Icon(Icons.payment),
                            ),
                    ...
                    if (selectedPaymentMethod == 'UPI') _buildUpiIdField(),
  ...
  bool _canProceedToPayment() {
    if (selectedPaymentMethod == null || _addressController.text.isEmpty) {
      return false;
    }
    ...
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Text(
              'Your order has been placed successfully using $selectedPaymentMethod!',
            ),
            actions: <Widget>[
              TextButton(
                onPressed: () {
